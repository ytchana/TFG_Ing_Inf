...
public class User {
    ...
    private List<MapFrontend> maps = new ArrayList<>(); // Lista de mapas creados por el usuario
    ...
    public List<MapFrontend> getMaps() {
        return maps;
    }

    public void setMaps(List<MapFrontend> maps) {
        this.maps = maps;
    }
